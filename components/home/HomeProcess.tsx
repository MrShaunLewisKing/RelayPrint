    ...
    >
      <div className="max-w-[1120px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col lg:flex-row lg:gap-[56px] items-start">
          ...
          <div className="w-full lg:w-[38%] lg:sticky lg:top-[88px] relative mb-12 lg:mb-0">
            ...
            <div className="relative z-10 mt-[16px]">
              <span className="text-[0.6875rem] font-bold text-[#7C5CFF] tracking-[0.10em] uppercase block mb-3">
                HOW IT WORKS
              </span>
              ...
              <p className="mt-5 text-[1.0625rem] leading-[1.65] text-[#8E98AA] max-w-sm">
          ...
          <div className="w-full lg:w-[62%] relative">
            ...
            <div className="space-y-[32px] sm:space-y-[36px] relative z-10">
              {/* Step 01: Receive */}
              <div className="flex gap-x-8 opacity-0 animate-step-reveal [animation-delay:120ms] [animation-fill-mode:forwards]">
                ...
                <div className="grow">
                  <span className="text-[11px] sm:text-[12px] font-bold text-[#697386] block mb-1.5">
                    01
                  </span>
                  <h3 className="text-[20px] sm:text-[22px] font-[650] text-[#F8FAFC] leading-tight">
                    Receive
                  </h3>
                  <p className="mt-1.5 text-[14px] sm:text-[15px] leading-[1.6] text-[#A9B1C1] max-w-lg">
              ...
              <div className="flex gap-x-8 opacity-0 animate-step-reveal [animation-delay:440ms] [animation-fill-mode:forwards]">
                ...
                <div className="grow border-l-2 border-[#7C5CFF] pl-6 -ml-[33px] bg-linear-to-r from-[#7C5CFF]/[0.03] to-transparent py-1 pr-4 rounded-r-2xl">
                  <span className="text-[11px] sm:text-[12px] font-bold text-[#7C5CFF] block mb-1.5">
                    03
                  </span>
